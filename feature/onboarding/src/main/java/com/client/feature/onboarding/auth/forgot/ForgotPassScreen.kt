package com.client.feature.onboarding.auth.forgot
...
internal fun ForgotPass(
    ...
    AuthBaseScreen(
        pageTitle = R.string.feature_onboarding_forgot_password
    ) {
        ...
        Button(
            ...
            Text(
                ...
                text = stringResource(R.string.feature_onboarding_send_recovery_email),
